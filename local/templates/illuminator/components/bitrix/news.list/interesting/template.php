	...
	<div class="container-fluid">
		<div class="row">
			<div class="col-12">
				...
				<div class="interesting-slider swiper-slider">
					<div class="swiper-wrapper">
						<?foreach($arResult["ITEMS"] as $arItem):?>
							...
							?>
						<div class="swiper-slide interesting-slide">
							<a href = "<?=$arItem['PROPERTIES']['LINK']['VALUE']?>" class="interesting-slide__content">
								<div class="interesting-slide__image">
									<img src="<?=$arItem["PREVIEW_PICTURE"]["SRC"]?>" alt="" width="240" height="240">
								</div>
								<div class="interesting-slide__text">
									<div class="interesting-slide__tab default-tab <?=($arItem['PROPERTIES']['TAG']['XML_ID'] == 'new' ? 'default-tab--new': '')?>"><?=$arItem['PROPERTIES']['TAG']['VALUE']?></div>
									<div class="interesting-slide__title"><?=$arItem['NAME']?></div>
								</div>
							</a>
						</div>
						<?endforeach;?>
