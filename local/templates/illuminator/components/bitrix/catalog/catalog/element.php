...
<section class = "section product-block">
	<div class="container-fluid">
		<div class="row">
			<div class="col-12">
				<h2 class="section-title section-slider-title">Аналоги</h2>
			</div>
		</div>
		<div class="row">
			<div class="col-12">
...
<section class = "section product-block">
	<div class="container-fluid">
		<div class="row">
			<div class="col-12">
				<h2 class="section-title section-slider-title">Вас может заинтересовать</h2>
			</div>
		</div>
		<div class="row">
			<div class="col-12">
...
<section class = "section product-block">
	<div class="container-fluid">
		<div class="row">
			<div class="col-12">
				<h2 class="section-title section-slider-title">Вы недавно просматривали</h2>
			</div>
		</div>
		<div class="row">
			<div class="col-12">
