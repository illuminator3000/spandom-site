...
<div class="container-fluid">
	<div class="row">
		<div class="col-12"><h1 class="section-title">Акции</h1></div>
	</div>
</div>
		...
		<div class="row">
			<div class="col-12">
				<div class="hit-block__tags tags-switcher">
					<div class="tags-switcher__item active">Для юридических лиц</div>
					<div class="tags-switcher__item">Для физических лиц</div>
				</div>
			</div>
		</div>
