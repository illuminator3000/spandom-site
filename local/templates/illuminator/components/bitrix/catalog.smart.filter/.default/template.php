				...
				*/
				...
				foreach($arResult["ITEMS"] as $key=>$arItem)
				{
					...
					<div class="catalog-filter__element bx-filter-parameters-box <?if ($arItem["DISPLAY_EXPANDED"]== "Y"):?> open bx-active<?endif?>">
						<span class="bx-filter-container-modef"></span>
						<div class="catalog-filter__element-title">
							<span><?=$arItem["NAME"]?></span>
							<svg width="18" height="8" viewBox="0 0 18 8" fill="none" xmlns="http://www.w3.org/2000/svg">
								<path d="M0.900391 0.900024L8.90039 6.90002L16.9004 0.900024" stroke="#696B6D" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round" />
							</svg>
						</div>
						<div class="bx-filter-block" data-role="bx_filter_block">
							<div class="row bx-filter-parameters-box-container">
								...
								default://CHECKBOXES
									...
									<div class="catalog-filter__items-container">
										<div class="catalog-filter__items">
											<?foreach($arItem["VALUES"] as $val => $ar):?>
													<label data-role="label_<?=$ar["CONTROL_ID"]?>" class=" catalog-filter__item bx-filter-param-label <? echo $ar["DISABLED"] ? 'disabled': '' ?>" for="<? echo $ar["CONTROL_ID"] ?>">
															<input
																type="checkbox"
