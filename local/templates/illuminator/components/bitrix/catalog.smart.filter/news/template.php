...
<div class="bx-filter <?=$templateData["TEMPLATE_CLASS"]?> <?if ($arParams["FILTER_VIEW_MODE"] == "HORIZONTAL") echo "bx-filter-horizontal"?>">
	<div class="bx-filter-section">
		<form name="<?echo $arResult["FILTER_NAME"]."_form"?>" action="<?echo $arResult["FORM_ACTION"]?>" method="get" class="smartfilter catalog-filter">
				...
				*/
				...
				foreach($arResult["ITEMS"] as $key=>$arItem)
				{
					...
					if (
						...
						continue;
					?>
					<div class="catalog-filter__element bx-filter-parameters-box <?if ($arItem["DISPLAY_EXPANDED"]== "Y"):?> open bx-active<?endif?>">
						<span class="bx-filter-container-modef"></span>
						<div class="catalog-filter__element-title catalog-filter__element-title--blog">
						...
						<div class="bx-filter-block" data-role="bx_filter_block">
							...
							switch ($arItem["DISPLAY_TYPE"])
							{
								...
								default://CHECKBOXES
									?>
									<div class="catalog-filter__items-container">
										<div class="catalog-filter__items catalog-filter__items--blog">
											<?foreach($arItem["VALUES"] as $val => $ar):?>

													<label data-role="label_<?=$ar["CONTROL_ID"]?>" class=" catalog-filter__item-blog bx-filter-param-label  <? echo $ar["DISABLED"] ? 'disabled': '' ?>" for="<? echo $ar["CONTROL_ID"] ?>">
															<input
																type="checkbox"
																...
																onclick="smartFilter.click(this)"
															/>
															<div class="catalog-tags__item <? echo $ar["CHECKED"] ? 'active ' : '' ?>">
																<div class="bx-filter-param-text catalog-tags__item-name"><?=$ar["VALUE"];?></div>
																<div class="catalog-tags__item-icon">
																	<svg width="11" height="13" viewBox="0 0 11 13" fill="none" xmlns="http://www.w3.org/2000/svg">
																		<path d="M0.5 2L5.5 7M10.5 12L5.5 7M5.5 7L0.5 12M5.5 7L10.5 2" stroke="#222222" stroke-linecap="round" stroke-linejoin="round"></path>
																	</svg>
																</div>
															</div>
													</label>
